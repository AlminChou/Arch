...
import com.almin.arch.store.DataStorePreference

//别名
typealias EasyStore = EasyDataStore

object EasyDataStore : DataStoreOwner("App") {

    override suspend fun <V> put(key: String, value: V) {
        when (value) {
    ...
    override suspend fun <V> get(key: String, defaultValue: V): V {
