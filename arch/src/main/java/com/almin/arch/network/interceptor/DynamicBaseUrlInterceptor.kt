...
import com.almin.arch.network.urlprocessor.DefaultUrlProcessor
...
class DynamicBaseUrlInterceptor(private val urlProcessor: UrlProcessor = DefaultUrlProcessor()) : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val baseUrl: String? = urlProcessor.getBaseUrl("${request.url.scheme}://${request.url.host}",request.url.encodedPath)
